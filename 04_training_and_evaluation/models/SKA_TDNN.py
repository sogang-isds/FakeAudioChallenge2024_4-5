...
class SKA_TDNN(nn.Module):
    def __init__(self, block, C, model_scale, log_input=True, num_mels=80, num_out=192, resblock=ResBlock, **kwargs):
        ...
        self.torchfbank = torch.nn.Sequential(
            PreEmphasis(),
            torchaudio.transforms.MelSpectrogram(sample_rate=8000, n_fft=512, win_length=400, hop_length=160, \
                                                 f_min = 20, f_max = 3800, window_fn=torch.hamming_window, n_mels=num_mels),
            )
